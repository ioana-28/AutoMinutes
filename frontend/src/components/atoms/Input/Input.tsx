...
const Input = forwardRef<HTMLInputElement, InputProps>(
  ({ variant = 'text', className = '', type, ...rest }, ref) => {
    const baseClasses =
      'w-full rounded-md border border-[#7f9d86]/40 bg-[#efebe2] text-[#1f2937]';
    const variantClasses = {
      ...
      compact: 'min-h-[28px] px-2 py-[2px] text-xs focus:outline-none focus:ring-1 focus:ring-[#386641] transition-shadow',
    };
    const resolvedType =
