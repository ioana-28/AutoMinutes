...
import AttendeeDeleteDialog from '@organisms/AttendeeDeleteDialog/AttendeeDeleteDialog';
import AddAttendeeSection from '@organisms/AddAttendeeSection/AddAttendeeSection';
import AttendeeList from '@organisms/AttendeeList/AttendeeList';
...
const AttendeesListPopup: FC<IAttendeesListPopupProps> = ({ isOpen, ...props }) => {
  ...
  return (
    <>
      ...
      <AttendeeDeleteDialog {...deleteDialogProps} />
    </>
  );
};
