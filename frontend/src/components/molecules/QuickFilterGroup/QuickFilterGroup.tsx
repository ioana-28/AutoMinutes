...
const QuickFilterGroup: FC<IQuickFilterGroupProps> = ({
  ...
  return (
    <div className={`flex flex-wrap gap-1.5 sm:gap-3 ${className}`.trim()}>
      {timeButtons.map((btn) => {
        ...
        return (
          <button
            ...
            className={`rounded-full border-[1.5px] px-2 py-0.5 sm:px-3 sm:py-1 text-[8px] sm:text-[9px] font-bold uppercase tracking-widest transition-all ${
              isActive
