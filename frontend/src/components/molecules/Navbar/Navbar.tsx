...
const Navbar: FC<INavbarProps> = ({ leftSlot, rightSlot }) => (
  <header className="relative z-[100] w-full border-b border-[#c7e8cd] bg-[#386641] px-6 py-4 shadow-[0_8px_24px_-18px_rgba(15,23,42,0.45)]">
    <nav
      className="mx-auto flex max-h-[30px] max-w-[1200px] items-center justify-between gap-4"
